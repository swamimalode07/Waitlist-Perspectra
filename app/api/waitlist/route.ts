...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #6b46c1; padding: 40px 20px; line-height: 1.6; margin: 0;">
  <div style="max-width: 400px; margin: 0 auto; background: #1f1937; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.3);">
    
    <!-- Hero Image -->
    <img src="https://raw.githubusercontent.com/swamimalode07/Waitlist-Perspectra/main/public/banner.png" alt="AI Perspectives" style="width: 100%; height: 200px; object-fit: cover; display: block;" />
    
    <!-- Main Content -->
    <div style="padding: 32px 24px; text-align: center;">
      <h1 style="font-size: 28px; font-weight: 700; color: white; margin: 0 0 16px 0;">You're on the Waitlist!</h1>
      
      <p style="font-size: 16px; color: #c4b5fd; margin: 0 0 24px 0;">
    ...
    <!-- Footer -->
    <div style="background: #0f0a1a; padding: 16px 24px; text-align: center;">
