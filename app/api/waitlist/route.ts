...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc; padding: 40px 20px; line-height: 1.6;">
  <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);">
    <img src="https://perspectra.live/image.png" alt="Team collaboration" style="width: 100%; height: 240px; object-fit: cover; display: block;" />
    <div style="padding: 48px 40px; text-align: center;">
      <h1 style="font-size: 36px; font-weight: 600; color: #1a202c; margin-bottom: 24px;">You're in!</h1>
      ...
      <p style="font-size: 16px; color: #718096; margin-bottom: 40px;">
        Perspreta is a new product that helps teams build better insights and more effective data perspectives in less time. During our beta, we're looking for people who are eager to try new software with their teams and give feedback. Is that you? Great — let’s go!
      </p>
      <a href="https://perspectra.live/signup" style="display: inline-block; background-color: #4c51bf; color: white; padding: 16px 32px; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 16px; margin-bottom: 32px;">Create your account</a>
    ...
    <div style="background-color: #f8fafc; padding: 32px 40px; text-align: center; border-top: 1px solid #e2e8f0;">
      <p style="font-size: 13px; color: #a0aec0;"><strong>© 2025 Perspreta.</strong> All rights reserved.</p>
      <p style="font-size: 13px; color: #a0aec0;">This email was sent because you signed up for Perspreta beta access.</p>
    </div>
  </div>
</body>
</html>`;
